...
class DesktopUseClient:
    ...
    def _make_request(self, endpoint: str, payload: Any, response_model: Optional[Type[T]] = None) -> Any:
    ...
    def ocr_screenshot(self, image_base64: str, width: int, height: int) -> OcrResponse:
        ...
        # Don't enforce a response model - get raw dict instead
        return self._make_request("/ocr", payload, response_model=None)
